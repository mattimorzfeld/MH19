function TunePFDWD(Ne,inflAll,SetUp,Gap)
...
for kk = 1:length(inflAll)
    ...
    [Xa,xAll,rho,traceP] = PF_DWD(Ne,infl,z,xo,sqrtPo,dt,dT,sqrtQ,H,R);
    ...
    Filename = strcat('./Results/PFDWD_Results_SetUp_',num2str(SetUp),'_Gap_',num2str(Gap), ...
